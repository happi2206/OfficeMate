...
struct Stretch_3_View: View {
    @State private var timeRemaining: Int = 15
    @State private var progress: CGFloat = 1.0
    @State private var navigateToStretch4: Bool = false
        ...
        NavigationStack {
            ZStack {
                VStack(spacing: 0) {
                    ...
                    Text("Head Up and Down")
                        .font(.system(size: 24, weight: .semibold))
                        .foregroundColor(Color(red: 0.2, green: 0.33, blue: 0.27))
                        .padding(.top, 40)
                    
                   
                    GIFImage(name: "shoulder_drop_stretch_slow")
                    ...
                    Text("Look up, then down. Repeat slowly.")
                        .font(.system(size: 16))
            ...
            .navigationDestination(isPresented: $navigateToStretch4) {
                Stretch_4_View()
            }
        }
    }
