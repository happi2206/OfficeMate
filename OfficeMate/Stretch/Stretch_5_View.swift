...
struct Stretch_5_View: View {
    @State private var timeRemaining: Int = 15
    @State private var progress: CGFloat = 1.0
    @State private var navigateToStretch6: Bool = false
        ...
        NavigationStack {
            ZStack {
                VStack(spacing: 0) {
                    ...
                    Text("Lift arms from side to high,\n then lower. Repeat gently.")
                        .font(.system(size: 16))
            ...
            .navigationDestination(isPresented: $navigateToStretch6) {
                Stretch_6_View()
            }
            .onAppear {
                timeRemaining = 15
